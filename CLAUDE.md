...
**FNO3d Model (src/architecture.py, src/train.py):**
...
**Normalization (train.py:184-214):**
...
**Training combines two losses (train.py:228, 257-258):**
...
- When adapting code, update paths in `data()` function (train.py:184), `unormalize()` (train.py:216), and inference loading (inference.py:27, 36, 39)
...
- Time dimension undergoes padding/unpadding (train.py:90, 121) but spatial dims don't
